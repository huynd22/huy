      ...
      <div className="flex gap-6 items-stretch">
        ...
        <div className="flex flex-col justify-between gap-2 flex-1">
          <div>
            ...
            <p className="font-lao-man border-l pl-4 border-black text-[16px]">
          ...
          <div>
            <div className="flex gap-3 mb-2 justify-between">
              <div className="flex gap-6 items-center">
                <div className="size-20 bg-[#D9D9D9] rounded-full flex items-center justify-center">
                  <svg
                    width="35"
                    height="37"
                    viewBox="0 0 35 37"
            ...
            <p className="text-base font-lao-man border mt-8 border-black p-6 rounded-[9px]">
